  ...
  return new Promise((resolve, reject) => {
    ...
    const renderSection = (title, rows) => {
      ...
      for (const [key, val] of rows) {
        ...
        // Page-break guard: leave room for at least this row + a little margin
    ...
    // switchToPage() moves the cursor and causes blank overflow pages.
    // Instead, register a listener that draws the footer as each page is
    // opened — before any content is placed on it.
    let pageNumber = 0;
